...
{
	var location={lat: $_SESSION['lat'],lng: $_SESSION['long']};
...
//$link="https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=lat,long,radius=500&type=doctor&key=AIzaSyDtRVL608rSdYKjmMIlgRNwRgkqDU0zhi0";
$cont = file_get_contents("https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=26.2196,84.3567&radius=10000&type=hospital&key=AIzaSyD6PyURM2qCatrH37nHiDfDzZPlJVaxvLU", false, stream_context_create($arrContextOptions));
